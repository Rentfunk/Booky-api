 ...
 */
final class Version20210913224333 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE class_has_book (id INT AUTO_INCREMENT NOT NULL, classroom_id INT NOT NULL, book_id INT NOT NULL, books_owned INT NOT NULL, books_returned INT NOT NULL, INDEX IDX_2277B33E6278D5A8 (classroom_id), INDEX IDX_2277B33E16A2B381 (book_id), UNIQUE INDEX UNIQ_2277B33E6278D5A816A2B381 (classroom_id, book_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE grade (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE teacher_has_book (id INT AUTO_INCREMENT NOT NULL, teacher_id INT NOT NULL, book_id INT DEFAULT NULL, books_owned INT NOT NULL, books_returned INT NOT NULL, INDEX IDX_97AFCBE541807E1D (teacher_id), INDEX IDX_97AFCBE516A2B381 (book_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
